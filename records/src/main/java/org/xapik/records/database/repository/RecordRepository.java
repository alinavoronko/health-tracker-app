...
public interface RecordRepository extends ReactiveCassandraRepository<Record, Integer> {
    @AllowFiltering
    Flux<Record> findByUserIdAndTypeAndUntilTimeGreaterThanEqualAndFromTimeLessThanEqual(int userId, RecordType type, LocalDateTime untilTime, LocalDateTime fromTime);
